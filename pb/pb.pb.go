...
const file_pb_pb_proto_rawDesc = "" +
	"\n" +
	"\vpb/pb.proto\x12\x02pb\"G\n" +
	"\aRequest\x12\x14\n" +
	...
	"\x05value\x18\x01 \x01(\bR\x05value2\x82\x01\n" +
	"\x02PB\x12&\n" +
	"\x03Get\x12\v.pb.Request\x1a\x12.pb.ResponseForGet\x12&\n" +
	"\x03Set\x12\v.pb.Request\x1a\x12.pb.ResponseForGet\x12,\n" +
	"\x06Delete\x12\v.pb.Request\x1a\x15.pb.ResponseForDeleteB\vZ\tLCache/pbb\x06proto3"
...
var file_pb_pb_proto_depIdxs = []int32{
	0, // 0: pb.PB.Get:input_type -> pb.Request
	0, // 1: pb.PB.Set:input_type -> pb.Request
	0, // 2: pb.PB.Delete:input_type -> pb.Request
	1, // 3: pb.PB.Get:output_type -> pb.ResponseForGet
	1, // 4: pb.PB.Set:output_type -> pb.ResponseForGet
	2, // 5: pb.PB.Delete:output_type -> pb.ResponseForDelete
